...
from utils import timer, red, green, yellow
...
def main():
    ...
    # 数据处理
    test_contents = DataProcessor.get_formal_data(segmentation, test_contents, stop_words)
    ...
    test_contents_seq = DataEncoder.word_encoder(
        contents, vocab_size, test_contents
    )
